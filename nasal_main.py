...
def write_to_rank(rank, text):
    ...
    with open(f'nasal_data/rank{rank}.txt', 'a', encoding='utf-8') as file:
        file.write(text + '\n')
...
if __name__ == '__main__':
    ...
    with open('nasal_data/nasal_queries.txt', 'r') as search_queries:
    ...
    for query in queries:
        ...
        for doi, info in bot_search.items():
            status, doi = doi_checker(doi, 'nasal_data/doi_db.txt')
    ...
    with open('nasal_data/log.txt', 'a') as log:
